...
patch_embed_ecg = PatchEmbed(img_size=seq_length, patch_size=patch_size, embed_dim=embed_dim)

# Generate random 12-lead ECG data
x = torch.randn(50, 1, seq_length)  # Shape: (batch_size, 1, sequence_length)
